...
class DownloadZipActivityForSingle : AppCompatActivity() {
    ...
    private fun showPopLauchOnline() {
        ...
        val builder = AlertDialog.Builder(this@DownloadZipActivityForSingle)
    ...
    */
    ...
    private fun stratMyACtivity() {
        try {
            ...
            // startActivity(Intent(applicationContext, SplashVideoActivity::class.java))
            // finish()
